    ...
    <main>
        ...
        <div class="slider-area slider-bg ">
            <div class="slider-active">
                ...
                <br>
                <br>
                <h3  style="  margin-left: 550px; font-size:20px; color: #F067FF; margin-top: -300px; "> View Status and Download file</h3>               
                <table style=" color: #000">
                    ...
                    <tr>
                        ...
                        <td style='font-weight: bold;'><%=rs.getString("user")%></td>
                        <td style='font-weight: bold;'><%=rs.getString("image")%></td>
                        <td style='font-weight: bold;'><a href='download.jsp?id=<%=rs.getString("id")%>&&user=<%=rs.getString("user")%>&&image=<%=rs.getString("image")%>&&tkey=<%=rs.getString("tkey")%>&&skey=<%=rs.getString("skey")%>' style='color:  chartreuse;'>Download</a></td>
                     </tr><%}%>
                </table> 
