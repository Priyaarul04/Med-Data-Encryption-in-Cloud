...
<body>
    ...
    <main>
        ...
        <div class="slider-area slider-bg ">
            ...
            <br>
            <br>
            <h2 align="center" style=" color:  #F067FF;  font-weight: bold; margin-left: 300px; font-size: 20px; margin-top:-100px;"> Upload File</h2><br><br>
   <div class="container">
                            <%
...
System.out.println("unique password ="+tkey);
        ...
        %>
                      <form action='Upload.jsp' method="post" >       
                             ...
                             <table style=" font-size:15px;margin-top:-300px;" align="center">
