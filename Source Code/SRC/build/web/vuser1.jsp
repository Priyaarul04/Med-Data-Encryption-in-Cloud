...
<body>
                                        ...
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                             <li><a href="index.html">Home</a></li>
                                                <li><a href="vowner1.jsp">View Owners</a></li>
                                                 <li><a href="vuser1.jsp">View Users</a></li>
    ...
    <main>
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" margin-top: -200px;  color: #F067FF; font-weight: bold; font-size: 20px; ">View all Owners Details !</h2><br><br>
   <div class="container">
       <br>
                        ...
                        while(rs.next()){
                         %>
                           ...
                           <td><%=rs.getString("location")%></td>
                             <td><a href="uauth.jsp?sno=<%=rs.getString("sno")%>"><%=rs.getString("status")%></a></td>
                            </tr>
                            <%}%></table> </form>  
