...
<body>
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="proreq.jsp">Proxy Re-encryption Request</a></li>
    ...
    <main>
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" color: white;  font-size: 23px; margin-top:-200px;  margin-left: 400px; ">View all Download file Request</h2><br><br>
   <div class="container">
       <br>
      ...
      String id=session.getAttribute("id").toString();
                        ...
                        PreparedStatement query=con.prepareStatement("select * from porequest where status='Waiting' ");
                        ...
                        <tr>
                            ...
                            <td style=" color: #00cae3;"> <img src="profile//img1.jpg" style="width:80px; height: 80px;"><%=rs.getString("image")%></td>
                             ...
                             <td > <a href="filacpt1.jsp?id=<%=rs.getString("id")%>" style="color: chartreuse; "><%=rs.getString("status")%></a></td></tr>
