...
<body>
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="vowner.jsp">View Owners</a></li>
                                                 <li><a href="vuser.jsp">View Users</a></li>
                                                  <li><a href="sndkey.jsp">Send Key</a></li>
    ...
    <main>
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" margin-top: -200px;  color: #F067FF; font-weight: bold; font-size: 20px; ">View all  Uploaded Files and Information !</h2><br><br>
   <div class="container">
       <br>
