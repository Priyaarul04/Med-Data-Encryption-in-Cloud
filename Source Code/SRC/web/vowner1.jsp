...
<body>
    ...
    <main>
        ...
        <div class="header-text">
            ...
            <br>
            <br>
            <h2 align="center" style=" margin-top: -200px;  color: #F067FF; font-weight: bold; font-size: 20px; ">View all Users Details !</h2><br><br>
   <div class="container">
       <br>
  ...
  <%                    
                        ...
                        while(rs.next()){
                         ...
                         %>
                           ...
                           <td><a href="oauth.jsp?sno=<%=rs.getString("sno")%>"><%=rs.getString("status")%></a></td>
                            </tr>
                            <%}%></table> </form>  
